...
// console.log("enterrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr22")

// if(process.env.NODE_ENV==='production'){
// app.use(express.static(path.join(_dirname1,"/frontendnew/build")));
// console.log("enterrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr")
// app.get("*",(req,res)=>{
//     res.sendFile(path.resolve(_dirname1,"frontendnew","build","index.html")) 
// });
